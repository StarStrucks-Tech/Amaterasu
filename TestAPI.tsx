...
import { View, TouchableOpacity, Button, Modal, Text, StyleSheet } from 'react-native'
...
export default function TestAPI() {
   ...
   */
    const postPrivateData = async () => {
        const privateResponse = await postPrivateAPI(endpoint, oauthToken, userData);
        ...
        <View style={styles.container}>
            ...
            <Modal visible={modalVisible1} animationType="slide">
                <View style={styles.modalContainer}>
                    ...
                    <TouchableOpacity style={styles.modalButton} onPress={patchPublicData}>
                        <Text style={styles.modalButtonText}>PATCH public API data</Text>
                    </TouchableOpacity>
                    {/* Button to call DELETE public API data */}
                    <TouchableOpacity style={styles.modalButton} onPress={deletePublicData}>
            ...
            <Modal visible={modalVisible2} animationType='slide'>
                <View style={styles.modalContainer}>
                    ...
                    <TouchableOpacity style={styles.modalButton} onPress={postPrivateData}>
                    ...
                    <TouchableOpacity style={styles.modalButton} onPress={patchPrivateData}>
                        <Text style={styles.modalButtonText}>PATCH private API data</Text>
                    </TouchableOpacity>
                    {/* Button to call DELETE private API data */}
                    <TouchableOpacity style={styles.modalButton} onPress={deletePrivateData}>
