...
const UNAUTHORIZED_ERROR_MESSAGE = 'Invalid or expired token. Please re-authenticate.';
const FORBIDDEN_ERROR_MESSAGE = 'Invalid API token. Please check your API token and try again.';
...
export const getPrivateAPI = async (endpoint, oauthToken) => {
    try {
        ...
        instance.defaults.headers.common[AUTHORIZATION_HEADER] = `${BEARER_TOKEN_TYPE} ${oauthToken}`;
