    ...
    <View
      ...
      <View style={styles.alignImage}>
        ...
        <Text
          ...
          {BiometricConsentConstants.SECURE_LOGIN_TEXT}
        </Text>
      </View>
      <View style={styles.align}>
        <Text
          style={[
            styles.topText,
            isDarkMode ? styles.darkTopText : styles.lightTopText,
          ]}>
          {BiometricConsentConstants.DEVICE_UNLOCK_TEXT}
        </Text>
        <Image source={require('../assets/padlock.png')} style={styles.lock} />
      </View>
      <Text
        style={[styles.para, isDarkMode ? styles.darkPara : styles.lightPara]}>
        {BiometricConsentConstants.WARNING_TEXT}
      </Text>
      {/* Button with arrow icon and text */}
      <TouchableOpacity style={styles.button} onPress={handleButtonPress}>
        <Image source={require('../assets/arrow.png')} style={styles.arrow} />
        <Text style={styles.buttontext}>
          {BiometricConsentConstants.BUTTON_TEXT}
        </Text>
      </TouchableOpacity>
    </View>
  );
