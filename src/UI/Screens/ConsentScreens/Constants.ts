...
export const BiometricConsentConstants = {
  ...
  WARNING_TEXT:
    'By using your fingerprint or face ID to unlock your device and access the KUBAIR App, you agree to do so securely. Please note that adding other fingeprints or face IDs is not recommended and could result in a loss of financial data',
  BUTTON_TEXT: 'I Understand',
};

//Constants for Other Consents Screen
export const OtherConsentsConstants = {
  ...
  LOCATION_TEXT:
    'We need your location to provide you with a better experience.',
  ...
  PERMISSION_PARAGRAPH:
    'To have a smooth account creation process with no hiccups and safeguard your account',
};
...
export const TermsConditionsConstants = {
  ...
  AGREEMENT:
    'I agree to the above terms & conditions that I am Indian citizen, my country of tax residence is India and I am not (nor am related to) a politically exposed person',
  DATA_SHARE:
    'I agree to share personal data with KUBAIR and partners, to be accessed, stored & used for providing services',
  NEXT_BTN: 'Next',
