    ...
    <View style={styles.container}>
      ...
      <View>
        <Text style={styles.topText}>
          {OtherConsentsConstants.PERMISSION_HEADER}
        </Text>
        <Text style={styles.para}>
          {OtherConsentsConstants.PERMISSION_PARAGRAPH}
        </Text>
      </View>
      ...
      <View style={styles.checkbox}>
        <CheckBox
          ...
          tintColors={{true: '#d05f33'}}
        />
        <Text style={styles.agreeText}>
          {OtherConsentsConstants.AGREEMENT_TEXT}
        </Text>
      </View>
      <TouchableOpacity style={styles.button} onPress={handleButtonPress}>
        <Text style={styles.buttontext}>
          {OtherConsentsConstants.NEXT_BTN_TEXT}
        </Text>
      </TouchableOpacity>
        ...
        <View style={styles.alertContainer}>
          <View style={styles.alertContent}>
            <Text style={styles.alertTitle}>
              {OtherConsentsConstants.PERMISSION_REQUIRED_HEADER}
            </Text>
            <Text style={styles.alertMessage}>
              {OtherConsentsConstants.PERMISSION_ALERT_MESSAGE}
            </Text>
            <TouchableOpacity style={styles.okButton} onPress={handleOKPress}>
              <Text style={styles.okButtonText}>
                {OtherConsentsConstants.OK_BTN_TEXT}
              </Text>
            </TouchableOpacity>
          </View>
        </View>
