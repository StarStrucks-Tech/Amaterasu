...
class RequestHeader$Type extends MessageType<RequestHeader> {
  constructor() {
    super('core.RequestHeader', [
      ...
      {no: 3, name: 'secure_token', kind: 'scalar', T: 9 /*ScalarType.STRING*/},
      {
        ...
        name: 'platform',
        kind: 'enum',
        T: () => ['core.Platform', Platform, 'PLATFORM_'],
      },
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* core.AppVersion app_version */ 2:
          message.appVersion = AppVersion.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.appVersion,
  ...
  internalBinaryWrite(
    ...
    if (message.appVersion)
      AppVersion.internalBinaryWrite(
        message.appVersion,
    ...
    super('core.ResponseHeader', [
      {
        ...
        name: 'response_code',
        kind: 'enum',
        T: () => ['core.ResponseCode', ResponseCode, 'RESPONSE_CODE_'],
      },
      {
        no: 2,
        name: 'error_message',
