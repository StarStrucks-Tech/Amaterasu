    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* ui.Text modal_text */ 2:
          message.modalText = Text.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.modalText,
        ...
        case /* ui.Button modal_button */ 3:
          message.modalButton = Button.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.modalButton,
        ...
        case /* ui.CornerRadius modal_radius */ 6:
          message.modalRadius = CornerRadius.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.modalRadius,
