...
// @generated from protobuf file "protos-frontend/screens/onboarding_screen_options.proto" (package "screens", syntax proto3)
// tslint:disable
...
/**
 * @generated from protobuf message screens.OtherConsentsScreen
 */
...
/**
 * @generated from protobuf message screens.BiometricConsentScreen
 */
...
/**
 * @generated from protobuf message screens.LivenessCheckScreen
 */
...
/**
 * @generated from protobuf message screens.PanVerificationScreen
 */
...
/**
 * @generated from protobuf message screens.PhoneVerificationScreen
 */
...
/**
 * @generated from protobuf message screens.PhoneOTPScreen
 */
...
/**
 * @generated from protobuf message screens.EmailVerificationScreen
 */
...
/**
 * @generated from protobuf message screens.TermsConditionsScreen
 */
...
class OtherConsentsScreen$Type extends MessageType<OtherConsentsScreen> {
    constructor() {
        super("screens.OtherConsentsScreen", [
...
/**
 * @generated MessageType for protobuf message screens.OtherConsentsScreen
 */
...
class BiometricConsentScreen$Type extends MessageType<BiometricConsentScreen> {
    constructor() {
        super("screens.BiometricConsentScreen", [
            { no: 1, name: "resp_header", kind: "message", T: () => ResponseHeader },
...
/**
 * @generated MessageType for protobuf message screens.BiometricConsentScreen
 */
...
class LivenessCheckScreen$Type extends MessageType<LivenessCheckScreen> {
    constructor() {
        super("screens.LivenessCheckScreen", [
            { no: 1, name: "resp_header", kind: "message", T: () => ResponseHeader },
...
/**
 * @generated MessageType for protobuf message screens.LivenessCheckScreen
 */
...
class PanVerificationScreen$Type extends MessageType<PanVerificationScreen> {
    constructor() {
        super("screens.PanVerificationScreen", [
            { no: 1, name: "resp_header", kind: "message", T: () => ResponseHeader },
...
/**
 * @generated MessageType for protobuf message screens.PanVerificationScreen
 */
...
class PhoneVerificationScreen$Type extends MessageType<PhoneVerificationScreen> {
    constructor() {
        super("screens.PhoneVerificationScreen", [
            { no: 1, name: "resp_header", kind: "message", T: () => ResponseHeader },
...
/**
 * @generated MessageType for protobuf message screens.PhoneVerificationScreen
 */
...
/**
 * @generated MessageType for protobuf message screens.PhoneOTPScreen
 */
...
class EmailVerificationScreen$Type extends MessageType<EmailVerificationScreen> {
    constructor() {
        super("screens.EmailVerificationScreen", [
            { no: 1, name: "resp_header", kind: "message", T: () => ResponseHeader },
            { no: 2, name: "title", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 3, name: "sub_title", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
...
/**
 * @generated MessageType for protobuf message screens.EmailVerificationScreen
 */
...
class TermsConditionsScreen$Type extends MessageType<TermsConditionsScreen> {
    constructor() {
        super("screens.TermsConditionsScreen", [
...
/**
 * @generated MessageType for protobuf message screens.TermsConditionsScreen
 */
